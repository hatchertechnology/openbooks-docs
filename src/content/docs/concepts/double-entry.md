...
[Invariants](/openbooks-docs/concepts/invariants/) and the reports on
[account balances, income statement, and balance sheet](/openbooks-docs/api/reports/).
...
[`AccountType::sign()`](/openbooks-docs/concepts/invariants/#report-sign-flipping-accounttypesign) —
...
convention — see [Invariants](/openbooks-docs/concepts/invariants/) for exactly where. If you
...
store. Amounts are cents, per [Money](/openbooks-docs/concepts/money/).
...
above. See [No accounting vocabulary in the UI](/openbooks-docs/concepts/invariants/#no-accounting-vocabulary-in-the-ui).
