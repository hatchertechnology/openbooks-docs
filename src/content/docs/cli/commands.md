...
by passing a subcommand instead of launching the [TUI](/openbooks-docs/cli/tui/). Definitions come
...
the [TUI's History tab](/openbooks-docs/cli/tui/) (the `d` key), or directly against the API.
